...
def main():
 ...
 labeled_batches=len(ls['labeled']);full_cycles,remainder=divmod(steps,labeled_batches)
 labeled_exposures_per_epoch=full_cycles*len(ls['labeled'].dataset)+remainder*a.batch_size
